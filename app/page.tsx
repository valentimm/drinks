...
export default function Home() {
  return (
    <div className="w-5/6 h-[48rem] mx-auto my-10 bg-card1 rounded-2xl shadow-lg flex items-center justify-center">
      <div className="mt-4 flex flex-col items-center w-full h-full p-8 gap-4 rounded-lg">
        ...
        <div className="px-18 flex flex-wrap gap-4 items-center justify-between w-full h-full border-accent border-2">
          ...
          <div className="sm:w-[46rem] sm:h-[31rem] bg-card2 rounded-lg p-8 px-12 shadow-lg flex flex-col items-center gap-4">
            <span className="text-3xl font-bold text-text">Nome do Drink</span>
            <span className="text-lg text-text-secondary">Categoria: Cocktail</span>
            <span className="text-lg text-text-secondary">Álcool: Sim</span>
            <span className="text-lg text-text-secondary">Ingredientes:</span>
